-- Ensure unique 6-digit instructor numbers for all instructors

-- Function to generate unique 6-digit instructor number
...
-- Create trigger to auto-generate instructor number on insert
