...
const styles = StyleSheet.create({
  ...
  gridArea: { paddingLeft: 64, paddingRight: 8 },
  gridHourRow: { height: 120, flexDirection: "row", alignItems: "center" },
  leftLabelCell: { width: 64, position: "absolute", left: 0, paddingLeft: 8 },
  leftLabelText: { color: "#9ca3af", fontWeight: "600" },
  rightRow: { flex: 1, height: "100%" },
  hourLine: { height: 1, backgroundColor: "#e5e7eb", opacity: 0.6 },
