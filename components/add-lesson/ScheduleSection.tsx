...
const styles = StyleSheet.create({
  ...
  recurrenceInput: { marginTop: 8, borderWidth: 1, borderColor: "#e5e7eb", borderRadius: 6, paddingHorizontal: 12, paddingVertical: 8, fontSize: 16, outlineWidth: 0, outlineStyle: "none" as const },
