  ...
  return (
    <View style={styles.card}>
      ...
      <View style={{ gap: 10 }}>
        ...
        <Row label="Uren gepland" value={`${round1(plannedHours)} u`} valueColor={noAdded ? "#22c55e" : "#2563eb"} />
        <Row label="Uren betaald" value={`${round1(hoursPaid)} u`} valueColor={noAdded ? "#22c55e" : "#111827"} />
        <Row label="Uren over" value={`${round1(hoursOver)} u`} valueColor={noAdded ? "#22c55e" : (hoursOver > 0 ? "#16a34a" : "#ef4444")} />
        <View style={{ height: 8 }} />
        {productRows.map((pr) => (
