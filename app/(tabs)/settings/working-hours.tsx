...
// Storage helpers: FileSystem on native, localStorage on web
...
export default function WorkingHoursScreen() {
    ...
    (async () => {
      ...
      if (v) {
        try {
          ...
          console.log("Failed to parse working hours", e);
        }
      }
      setLoading(false);
    })();
  ...
  const save = useCallback(async () => {
    ...
    setIsSaving(true);
    try {
      await storageSetString(STORAGE_KEY, JSON.stringify(workingHours));
      if (Platform.OS !== "web") {
